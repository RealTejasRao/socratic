...
export const ROUTES = {
  ...
  PRIVACY_POLICY_ALIAS: "/privacy-policy" as Route,
  TERMS: "/terms" as Route,
  SIGN_IN: "/sign-in" as Route,
  SIGN_UP: "/sign-up" as Route,
  APP: "/app" as Route,
  APP_ROLEPLAY: "/app?mode=roleplay" as Route,
  UPSC_APP: "/upsc/app" as Route,
  UPSC_APP_SOCRATIC: "/upsc/app?mode=socratic" as Route,
  UPSC_APP_ROLEPLAY: "/upsc/app?mode=roleplay" as Route,
