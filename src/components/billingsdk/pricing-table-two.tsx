...
interface DefaultCheckoutButtonProps {
  ...
  isAnnually: boolean;
  onPlanSelect: ((planId: string, cycle: BillingCycle) => void) | undefined;
}
...
function DefaultCheckoutButton({
  ...
  return (
    <Button
      ...
      onClick={() => onPlanSelect?.(plan.id, isAnnually ? "annual" : "monthly")}
    >
                  ...
                  >
                    <TableCell
                      className={cn(
                        ...
                        theme === "classic" && "text-foreground/90 font-semibold",
                      )}
                    >
                      {featureName}
                    </TableCell>
                            ...
                            feature.icon === "check" ? (
                              ...
                              <span
                                className={cn(
                                  ...
                                  theme === "classic" && "text-foreground/70 font-medium",
                                )}
                              >
                                {feature.name}
                              </span>
