...
const DEFAULT_WORDS = ["Philosophy", "Deep Convos", "Wisdom", "Growth"] as const;
...
export function HeroRotatingWord({
  ...
  return (
    <span
      className={`relative inline-grid align-baseline whitespace-nowrap text-[1.08em] ${className} ${
