                ...
                <div className="flex min-w-0 items-center gap-2 lg:gap-2">
                  {session.mode !== "SOCRATIC" && (
                    showModeBadges && (
                      <span
                        className={cn(
                          "app-session-mode-icon inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full border border-[var(--app-light-button-primary-bg)] bg-[var(--app-light-button-primary-bg)] text-[var(--app-light-button-primary-text)] transition-[background-color,border-color,color,transform] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] lg:h-6 lg:w-6",
                        )}
                      >
                        {session.mode === "DEBATE" ? (
                          <Swords size={13} />
