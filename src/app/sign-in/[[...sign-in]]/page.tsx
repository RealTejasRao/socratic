  ...
  return (
    <LoadGate fallbackClassName="min-h-svh w-screen bg-white">
      <main className="auth-page-fade relative min-h-svh w-screen overflow-hidden bg-white text-[#0f1720] lg:h-svh">
        ...
        <div className="signin-stars-layer-a absolute inset-0 bg-[radial-gradient(circle,rgba(0,0,0,0.95)_1.02px,transparent_1.3px)] bg-size-[54px_54px] bg-position-[11px_19px]" />
        <div className="signin-stars-layer-b absolute inset-0 bg-[radial-gradient(circle,rgba(0,0,0,0.9)_0.94px,transparent_1.22px)] bg-size-[69px_69px] bg-position-[33px_9px]" />
        <div className="signin-stars-layer-c absolute inset-0 bg-[radial-gradient(circle,rgba(0,0,0,0.82)_0.84px,transparent_1.08px)] bg-size-[87px_87px] bg-position-[23px_37px]" />
